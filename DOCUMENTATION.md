...
- **Scenes**: A játék különböző pályái és menüi (`BossScene`, `EnemyLevel`, `Intro`, `Outro`, `PuzzleLvL`, `TempMainMenu`).
...
- **TempMainMenu**: A főmenü, amely lehetőséget ad a játék indítására, a beállítások elérésére és a toplista megtekintésére.
